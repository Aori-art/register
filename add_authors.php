...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $author_id = uniqid("auth_");
    $author_fn = $_POST['authorFirstName'];
    $author_ln = $_POST['authorLastName'];
    $author_birthday = $_POST['authorBirthYear'];
    $author_nat = $_POST['authorNationality'];

    $db = new database();
    if ($db->addAuthors($author_id, $author_fn, $author_ln, $author_birthday, $author_nat)) {
